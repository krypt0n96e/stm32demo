...
/* Private variables ---------------------------------------------------------*/
extern osMessageQueueId_t Hangdoi_ngatHandle;
...
uint8_t RX_data;
const char* interupt_1="Thuc hien ngat 1\r\n";
const char* interupt_2="Thuc hien ngat 2\r\n";
const char* interupt_3="Thuc hien ngat 3\r\n";
/* USER CODE BEGIN PFP */
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart) {
    if (huart->Instance == huart1.Instance) { // Đảm bảo đúng instance
        ...
        switch (RX_data) {
            case 105: // RX_data = 105 -> Push ID1
                queue_item = 1; // ID1
                break;
            case 111: // RX_data = 111 -> Push ID2
                queue_item = 2; // ID2
                break;
